...
gamma = 0.99             #El factor discount esta dado por gamma 0.99 y T en 400s respectivamente 
learning_rate = 0.0002

memory_size = 2 ** 20
update_target_freq = 10000      #La red objetivo es actualizada con la frecuencia de 10000 frames y con opt Adam con learning rate de 0.0002

num_of_inputs  = 41             #entrada, salida, linear fully connected y noise layer tienen 41
hidden_1       = 512            #
hidden_2       = 512
hidden_3       = 64
num_of_outputs = 4              #numero de salidas 
...
def projection_distribution(next_state, reward, done, target_model):
    ...
    delta_z = float(Vmax - Vmin) / (num_of_atoms)
...
class DQN(object):
    ...
    def __init__(self, options, resume_previous_train):
        ...
        self.optimizer = optim.SGD(params=self.model.parameters(), lr=learning_rate)
        self.num_updates = 0
