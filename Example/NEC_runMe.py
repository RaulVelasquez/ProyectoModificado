...
num_episodes = 100000 # Número total de episodios

# e-greedy configuration  siempre que estan apagadas     et= factor de exploracion en el cuadro t
egreedy_init       = 1        #valor inicial 
egreedy_final      = 0.05     #valor final de la exploracion residual y sigma se ajusta  a 0.4 para inciar pesos de la Noise Layers
egreedy_decay      = 15000    #factor de decadencia 
